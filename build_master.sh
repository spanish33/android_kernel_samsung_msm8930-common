...
export MUXEDNAMELONG="cyanogenmod-$MREV-$CARRIER-$CURDATE"
export MUXEDNAMESHRT="cyanogenmod-$MREV-$CARRIER*"
export KTVER="--$MUXEDNAMELONG--"
export KERNELDIR=`readlink -f .`
export PARENT_DIR=`readlink -f ..`
export INITRAMFS_DEST=$KERNELDIR/kernel/usr/initramfs
export INITRAMFS_SOURCE=`readlink -f ..`/ramdisk/$CARRIER"_""$MREV"
export PACKAGEDIR=/home/spanish33/kernel/Packages
export ARCH=arm
export USE_CCACHE=1
export CCACHE_DIR=/home/spanish33/.ccache
export CCACHE=/home/spanish33/kernel/prebuilts/misc/linux-x86/ccache/ccache 
export CROSS_COMPILE="$CCACHE /home/spanish33/kernel/toolchains/sabermod-arm-eabi-4.10/bin/arm-eabi-"
#export CROSS_COMPILE="$CCACHE /home/spanish33/kernel/toolchains/arm-cortex_a15-linux-gnueabihf-linaro_4.9.2-2014.08/bin/arm-cortex_a15-linux-gnueabihf-"
...
make VARIANT_DEFCONFIG=msm8930_serrano_$CARRIER"_defconfig" SELINUX_DEFCONFIG=selinux_defconfig SELINUX_LOG_DEFCONFIG=selinux_log_defconfig cyanogen_serrano_defconfig

echo "Modding .config file - "$KTVER
sed -i 's,CONFIG_LOCALVERSION="-kartal",CONFIG_LOCALVERSION="'$KTVER'",' .config
